...
const AdminLogin = () => {
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-gradient-to-br from-[#0a0647] to-[#4427ad] relative overflow-hidden px-4 pt-10 pb-10 md:pt-0 md:pb-0">
      ...
      <div className="relative z-10 w-full max-w-[430px] bg-[#18116a]/[.97] rounded-xl md:rounded-2xl border border-[#9996dc] shadow-2xl px-3 md:p-6 flex flex-col">
        <h2 className="text-xl sm:text-2xl font-bold text-center text-white mb-6 mt-3 sm:mb-8 font-sans tracking-wide">
          Login Admin
        </h2>
        {error && (
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4">
          ...
          <div>
            ...
            <input
              ...
              className={`w-full px-2 py-2 rounded-md bg-[#f6f8ff] text-black text-base border-none outline-none font-medium ${
